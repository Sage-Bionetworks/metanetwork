...
All.Files = synQuery('select name,id,disease,normalization from file where projectId=="syn3455058" and fileType == "rda"'); # syn2397881
Finished.Files = synQuery('select name,id,disease,normalization from file where projectId=="syn3455058" and fileType == "RData"'); # syn2397881
